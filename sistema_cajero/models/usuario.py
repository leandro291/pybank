...
from utils.utils import limpiar_string
...
class Usuario(Persona):
    ...
    def vincular_cuenta(self, cuenta: "Cuenta") -> None:
    ...
    def obtener_cuenta(self, numero_cuenta: str) -> "Cuenta":
        ...
        numero_limpio = limpiar_string(numero_cuenta)
